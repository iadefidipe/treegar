            ...
            <PageSubSection>
              ...
              <SubSection>
                <ListSection>
                  ...
                  <SubList>
                    {privacyPolicy.personData.sub[0].text.map((list, index) => (
          ...
          <PageSection>
            ...
            <PageSubSection>
              <ListSection>
                ...
                <SubList>
                  {privacyPolicy.accessRight.sub[0].text.map((list, index) => (
                    <OrderedList key={index}> {list} </OrderedList>
                  ))}
                </SubList>
              </ListSection>
              ...
              <ListSection>
                <SubHeader>{privacyPolicy.accessRight.sub[1].header}</SubHeader>
              ...
              <ListSection>
                <SubHeader>{privacyPolicy.accessRight.sub[2].header}</SubHeader>
                <PageText>{privacyPolicy.accessRight.sub[2].sub}</PageText>
                <SubList>
                  {privacyPolicy.accessRight.sub[2].text.map((list, index) => (
                    <OrderedList key={index}> {list} </OrderedList>
                  ))}
                </SubList>
              </ListSection>
              ...
              <ListSection>
                <SubHeader>{privacyPolicy.accessRight.sub[3].header}</SubHeader>

                <PageText> {privacyPolicy.accessRight.sub[3].text} </PageText>
              </ListSection>

              <ListSection>
                <SubHeader>{privacyPolicy.accessRight.sub[4].header}</SubHeader>
